	...
	protected function register_style_form_coupon_controls() {
		...
		$this->add_group_control(
			...
			array(
				...
				'selector'  => '{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text',
				'condition' => array(
					'show_coupon' => 'yes',
				),
			)
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text' => 'width: {{SIZE}}{{UNIT}};',
				),
				'condition'  => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_responsive_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text' => 'height: {{SIZE}}{{UNIT}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors'  => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'size_units' => array( 'px', '%' ),
				'selectors'  => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				),
				'condition'  => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text:hover' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text:hover' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text:hover' => 'border-color: {{VALUE}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text:focus' => 'color: {{VALUE}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text:focus' => 'background-color: {{VALUE}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
		...
		$this->add_control(
			...
			array(
				...
				'type'      => Controls_Manager::COLOR,
				'selectors' => array(
					'{{WRAPPER}} #pp-woo-cart-{{ID}} .cart .coupon .input-text:focus' => 'border-color: {{VALUE}};',
				),
				'condition' => array(
					'show_coupon' => 'yes',
				),
