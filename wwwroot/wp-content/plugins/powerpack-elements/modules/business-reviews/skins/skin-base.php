		...
		$this->start_controls_section(
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .pp-review-wrap:not(.swiper-slide)' => 'padding-right: calc( {{SIZE}}{{UNIT}}/2 ); padding-left: calc( {{SIZE}}{{UNIT}}/2 );',
						'{{WRAPPER}} .pp-elementor-grid' => 'margin-left: calc( -{{SIZE}}{{UNIT}}/2 ); margin-right: calc( -{{SIZE}}{{UNIT}}/2 );',
					),
					'render_type'  => 'template',
				)
			);
			...
			$this->add_responsive_control(
				...
				array(
					...
					'selectors' => array(
						'{{WRAPPER}} .pp-review-wrap' => 'margin-bottom: {{SIZE}}{{UNIT}};',
					),
					'condition' => array(
						'layout!' => 'carousel',
					),
...
<g>
	...
	public function render() {
		...
		$layout_class = ( 'carousel' === $settings['layout'] ) ? 'pp-reviews-layout-carousel pp-swiper-slider swiper-container' : 'pp-elementor-grid pp-reviews-layout-grid';
		...
		$this->parent->add_render_attribute( 'review-wrap', 'class', 'pp-review-wrap pp-grid-item-wrap' );
